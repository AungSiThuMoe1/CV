        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: height,),
              Text('• Lead developer\n',style: TextStyle(fontSize:16,fontWeight: FontWeight.bold),),
              Text('- Food2u Co.,Ltd (May 2017-Aug 2017)',style: TextStyle(fontWeight: FontWeight.bold),),SizedBox(height: height,),
              SizedBox(height: height,),
              ...
              SizedBox(height: height,),
              Text('• Only developerSizedBox(height: 10,), for City Mart Holding\'s Shopper system application\n',style: TextStyle(fontWeight: FontWeight.bold),),
              SizedBox(height: height,),
